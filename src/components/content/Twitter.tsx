export const Twitter = (tmpUrl) => {
    ...
    //     id
    //   }`;
    // let tmpIframe = '<iframe id="' + id + '" border=0 frameborder=0 height=387 width=563 src="' + embedid + '" />'
    ...
    // Make #ry link by tag
    const out_linkr = '<a href="' + tmpUrl + '" target="_blank">__Twitter_X(r)</a>';
    // Make (c_YouTube) link by content
    const out_linkc = '<a href="' + tmpUrl + '" target="_blank">__(c_Twitter)</a>';

    return { out_iframe1, out_twitterIdText1, out_linkr, out_linkc };
